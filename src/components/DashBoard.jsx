 ...
 <div className="p-5 space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full font-medium">
            Screener
          </button>
        </div>
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide">
          {marketIndices.map((item, i) => (
            <div
              key={i}
              className="min-w-[150px] bg-white shadow border border-gray-100 rounded-xl p-3 flex flex-col justify-between"
            >
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-gray-800 font-semibold">Top Gainers <span className="text-xs text-gray-500">NIFTY100</span></h2>
          <button className="text-xs text-green-700 font-medium">See More</button>
        </div>
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide">
          {topGainers.map((item, i) => (
            <div
              key={i}
              className="min-w-[160px] bg-white shadow border border-gray-100 rounded-xl p-4 flex flex-col items-center text-center"
            >
              <img
                src={item.logo}
                alt={item.name}
              ...
              <p className="text-gray-900 font-semibold text-base mt-1">{item.price}</p>
              <span className="text-green-600 text-sm mt-1">{item.change}</span>
            </div>
          ))}
        </div>
      </div>
