...
const ELSSPlannerCalculator = () => {
    ...
    <div className="min-h-screen bg-linear-to-r from-blue-100 to-green-100">
      ...
      <div className="flex justify-center items-center p-6">
        <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2 border border-gray-200">
          ...
          {/* LEFT INPUTS */}
          <div className="p-8 bg-linear-to-br from-blue-50 to-cyan-50">
            <h2 className="text-2xl font-bold text-blue-700 mb-6">Enter Details</h2>
  ...
  className="w-full border border-blue-300 p-2 rounded-lg bg-white/80 focus:ring-2 focus:ring-blue-500"
/>
              </div>
...
/>
              ...
              <button
                ...
                className="mt-2 w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-bold transition"
              >
                Calculate
              </button>
            </div>
          ...
          {/* RIGHT RESULT */}
          <div className="p-8 bg-linear-to-br from-blue-500 to-cyan-500 text-white flex flex-col justify-center">
            <h3 className="text-xl font-bold mb-4">📊 ELSS Summary</h3>

            {result ? (
              <div className="bg-white/20 rounded-xl p-4 shadow-lg backdrop-blur-sm">
                <p className="text-lg"><strong>Estimated Value:</strong> ₹{Number(result.estimatedValue).toLocaleString()}</p>
                <p className="text-lg mt-2"><strong>Tax Saved (80C):</strong> ₹{result.taxSaved}</p>
                <p className="text-lg mt-2"><strong>Total Invested:</strong> ₹{result.totalInvested}</p>
              </div>
            ) : (
      ...
      <div className="max-w-4xl mx-auto mt-10 p-6 bg-linear-to-r from-blue-200 to-green-100 rounded-2xl shadow">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">FAQ — ELSS</h2>
