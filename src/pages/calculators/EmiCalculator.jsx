    ...
    <div className="min-h-screen bg-linear-to-r from-blue-100 to-green-100">
      ...
      <div className="flex justify-center items-center p-6">
        <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2 border border-gray-200">
          ...
          {/* LEFT INPUTS */}
          <div className="p-8 bg-linear-to-br from-orange-50 to-yellow-50">
            <h2 className="text-2xl font-bold text-orange-700 mb-6">Enter Details</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full outline-none border border-orange-300 p-2 rounded-lg bg-white/80 focus:ring-2 focus:ring-orange-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: 20"
                  className="w-full border border-orange-300 p-2 rounded-lg bg-white/80 focus:ring-2 focus:ring-orange-500 outline-none"
                />
              </div>
          ...
          {/* RIGHT RESULT */}
          <div className="p-8 bg-linear-to-br from-red-500 to-orange-500 text-white flex flex-col justify-center">
            <h3 className="text-xl font-bold mb-4">📊 EMI Summary</h3>

            {result ? (
              <div className="bg-white/20 rounded-xl p-4 shadow-lg backdrop-blur-sm">
                <p className="text-lg"><strong>Monthly EMI:</strong> ₹{Number(result.emi).toLocaleString()}</p>
                <p className="text-lg mt-2"><strong>Total Interest:</strong> ₹{Number(result.totalInterest).toLocaleString()}</p>
                <p className="text-lg mt-2"><strong>Total Payable:</strong> ₹{Number(result.totalPayable).toLocaleString()}</p>
              </div>
            ) : (
              <p className="opacity-95">Fill details to calculate EMI.</p>
            )}

            <p className="mt-6 text-sm opacity-90">💡 EMI helps you plan your loan repayment smartly.</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-10 p-6 bg-linear-to-r from-blue-200 to-green-100 rounded-2xl shadow">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">FAQ — EMI</h2>
      ...
      <div className="max-w-4xl mx-auto mt-10 p-6">
        ...
        <div className="flex gap-4 flex-wrap">
          <button onClick={() => navigate("/calculator/sip-calculator")} className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow">SIP Calculator</button>
          <button onClick={() => navigate("/calculator/cagr-calculator")} className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg shadow">CAGR Calculator</button>
