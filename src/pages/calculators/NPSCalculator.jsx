  ...
  return (
    <div className="min-h-screen  bg-linear-to-r from-blue-100 to-green-100">
      ...
      <div className=" py-14 px-6 text-center">
        <h1 className="text-4xl font-extrabold text-indigo-600 drop-shadow">
          NPS Calculator 🏦🔥
        </h1>
      ...
      <div className="flex justify-center items-center p-2">
        <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2 border border-gray-200">
          {/* LEFT PANEL */}
          <div className="p-8 bg-linear-to-br from-red-50 to-white">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  placeholder="Ex: 2000"
                  className="w-full border border-red-200 p-2 rounded-lg focus:ring-2 focus:ring-red-400 outline-none"
              ...
              <button
                ...
                className="mt-2 w-full bg-indigo-500 hover:bg-indigo-600 text-white py-2 rounded-lg font-bold text-sm transition"
              >
                Calculate
              </button>
            </div>
          ...
          {/* RIGHT PANEL RESULT */}
          <div className="p-8 bg-linear-to-br from-indigo-500 to-blue-400 text-white flex flex-col justify-center">
