  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-blue-100 to-green-100">
      ...
      <div className="bg-linear-to-r from-blue-100 to-green-100 py-14 px-6 text-center">
        <h1 className="text-4xl font-extrabold text-teal-700 drop-shadow">
          SWP Calculator 💸
        </h1>
      ...
      <div className="flex justify-center items-center p-6">
        <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2 border border-gray-200">
          ...
          {/* LEFT SECTION */}
          <div className="p-8 bg-linear-to-br from-teal-50 to-green-50">
            <h2 className="text-2xl font-bold text-teal-700 mb-6">Enter Details</h2>
              ...
              {[
                ...
                <div key={idx}>
                  ...
                  <input
                    ...
                    className={`w-full border p-2 rounded-lg focus:ring-2 outline-none bg-white/80
                      ${
                        errors[item.key]
                  ...
                  {/* error text */}
                  {errors[item.key] && (
                    <p className="text-red-500 text-xs mt-1">{errors[item.key]}</p>
                  )}
                </div>
              ))}
          ...
          {/* RIGHT SECTION */}
          <div className="p-8 bg-linear-to-br from-emerald-500 to-green-500 text-white flex flex-col justify-center">
            ...
            {result ? (
              ...
              <p className="opacity-95">Fill details and calculate to view summary.</p>
            )}
      ...
      <div className="max-w-4xl mx-auto mt-10 p-6">
        ...
        <div className="flex gap-4 flex-wrap">
          <button onClick={() => navigate("/calculator/lumpsum-calculator")} className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow">Lumpsum Calculator</button>
          ...
          <button onClick={() => navigate("/calculator/retirement-calculator")} className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg shadow">Retirement Calculator</button>
